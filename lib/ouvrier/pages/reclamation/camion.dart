import 'dart:io';
import 'package:estionnaire/ouvrier/pages/reclamation.dart';
...
class PanneCamion extends StatefulWidget {
  const PanneCamion({Key? key}) : super(key: key);
    ...
    return Scaffold(
        appBar: AppBar(
            leading: IconButton(
              ...
              onPressed: () => Get.to(const Signaler())
            ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.all(17), backgroundColor: Colors.black,
                          ),
                          child: const Icon(
                            Icons.qr_code,
                            color: Colors.white,
                    ...
                    child: ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(
                            vertical: 10, horizontal: 50), backgroundColor: const Color(0xFF196f3d),
                      ),
                    ),
                  )
                ],
