...
class AjouterRepateurPoubelle extends StatefulWidget {
  const AjouterRepateurPoubelle({Key? key}) : super(key: key);

  @override
  State<AjouterRepateurPoubelle> createState() => _AjouterRepateurPoubelleState();
}

class _AjouterRepateurPoubelleState extends State<AjouterRepateurPoubelle> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:const Text('Ajouter reparateur poubelle'),
      ),
      body: Padding(
              ...
              load? const Center(child: CircularProgressIndicator(),) :ElevatedButton(
                onPressed: (){
                  if(_formKey.currentState!.validate()){
                    ...
                    Provider.of<ReparateursProvider>(context,listen: false).ajouterRepateurPoubelle(data);
