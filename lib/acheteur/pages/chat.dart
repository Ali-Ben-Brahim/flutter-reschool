...
import '../pages/friend_message_card.dart';
  ...
  void initState() {
    ...
    message.conversationId =  widget.conversation.id;
      ...
      WidgetsBinding.instance.addPostFrameCallback((timeStamp)async{
        ...
        if(mounted){
        Provider.of<ConversationProvider>(context,listen: false).getConversation(_token);
...
//--------------------------------
  ...
  realTimeConversations(Timer t)async{
    try{
      List<ConversationModel> conv= Provider.of<ConversationProvider>(context , listen: false).conversations;
      var conversationsUpdated = conv.firstWhere((element) => element.id == widget.conversation.id) ;
      setState(() {
